...
for i in $TEST_FILES; do
    ...
    $top_builddir/clan $i -arraystag > $i.test 2>/tmp/clanout
    diff --ignore-matching-lines='/tests/' --ignore-matching-lines='generated by ' $i.test $i.scop
    z=`diff --ignore-matching-lines='/tests/' --ignore-matching-lines='generated by ' $i.test $i.scop 2>&1`
    err=`cat /tmp/clanout`;
    if ! [ -z "$z" ]; then
    ...
    z=`diff --ignore-matching-lines='/tests/' --ignore-matching-lines='generated by ' $i.parsetest $i.scop`
    if ! [ -z "$z" ]; then
